...
public extension DeviceProfile {
    ...
    public func attributeConfigs(on deviceId: String? = nil, isIncluded: @escaping (AttributeConfig)->Bool = { _ in true }) -> LazyFilterCollection<LazyMapCollection<[AferoAttributeDataDescriptor], AttributeConfig>> {
    ...
    public func attributeConfigs(on deviceId: String? = nil, withIdsIn range: ClosedRange<Int>) -> LazyFilterCollection<LazyMapCollection<[AferoAttributeDataDescriptor], AttributeConfig>> {
        return attributeConfigs(on: deviceId) { range.contains($0.dataDescriptor.id) }
    }
    
    public func attributeConfigs(on deviceId: String? = nil, withIdsIn platformAttributeRange: AferoPlatformAttributeRange) -> LazyFilterCollection<LazyMapCollection<[AferoAttributeDataDescriptor], AttributeConfig>> {
