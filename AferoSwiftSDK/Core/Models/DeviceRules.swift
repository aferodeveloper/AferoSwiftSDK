...
public extension DeviceModelable where Self: DeviceFilterCriteriaSource {
    ...
    public func update(_ filterCriterion: DeviceFilterCriterion, accumulative: Bool = false) throws {
...
//    }
    ...
    public var attributeDict: [Int: String] {
        return attributes.reduce([:]) {
            curr, next in
            var ret = curr
            ret[ next.attributeId] = next.stringValue
            return ret
        }
    }
