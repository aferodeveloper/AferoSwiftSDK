...
class AttributeValueDoubleSpec: QuickSpec {
    
    override func spec() {

        describe("When initializing") {
            
            it("should return an AttributeValue.Float64 when initialized from a Double literal") {

                let d1: Double = 2.2
                let av1 = AttributeValue(d1)
                expect(av1) == AttributeValue.float64(d1)
                expect(av1.doubleValue) == d1
                
                let d2: Double = -103333211.0328
                let av2 = AttributeValue(d2)
                expect(av2) == AttributeValue.float64(d2)
                expect(av2.doubleValue) == d2
                
            }

            it("should return an AttributeValue.Float64 when initialized from a the doubleValue of another AttributeValue instance") {
                ...
                let av2 = AttributeValue(av1.doubleValue!)
                expect(av2).toNot(beNil())
                expect(av2) == AttributeValue.float64(d1)
                expect(av2.doubleValue) == d1
            }
...
class AttributeValueFloatSpec: QuickSpec {
    
    override func spec() {
        
        describe("When initializing") {
            
            it("should return an AttributeValue.Float32 when initialized from a Float literal") {
                
                let d1: Float = 2.2
                let av1 = AttributeValue(d1)
                expect(av1) == AttributeValue.float32(d1)
                expect(av1.floatValue) == d1
                
                let d2: Float = -10333.3
                let av2 = AttributeValue(d2)
                expect(av2) == AttributeValue.float32(d2)
                expect(av2.floatValue) == d2
            ...
            it("should return an AttributeValue.Float64 when initialized from a the doubleValue of another AttributeValue instance") {
                ...
                let av2 = AttributeValue(av1.floatValue!)
                expect(av2).toNot(beNil())
                expect(av2) == AttributeValue.float32(d1)
                expect(av2.floatValue) == d1
            }
